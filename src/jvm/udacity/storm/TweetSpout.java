  ...
  private class TweetListener implements StatusListener {
    ...
    public void onStatus(Status status)
    {
      ...
      if(status.getGeoLocation() != null){
        String geoInfo = geoInfo = String.valueOf(status.getGeoLocation().getLongitude()) + "," + String.valueOf(status.getGeoLocation().getLatitude());
        queue.offer(status.getText() + "|" + geoInfo);
      }
    }
